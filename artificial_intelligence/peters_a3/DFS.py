...
class DFS():
    ...
    """
    def search(self):
        return self.dfs(self.problem.initial)
    ...
    def dfs(self, startState):
        ''' TODO -- Right now, the following algorithm is BFS implementation
        ...
        while len(frontier) > 0:
            node = frontier.pop() #pop from the right to do DFS (last one added to the deque will be popped)
